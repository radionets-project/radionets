...
from utils import process_img, write_h5, pointsources, gauss, gauss_pointsources
...
def main(out_path, num_img, sources, antenna_config_path, noise=False, specific_mask=False,
         lon=None, lat=None, steps=None):
    
    # Create num_img pointsources images with targets sources
    test_x = gauss_pointsources(num_img,sources)
