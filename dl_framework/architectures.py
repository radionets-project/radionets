...
class filter_deep_amp_unc(nn.Module):
    def __init__(self):
        ...
        self.conv_con1 = nn.Sequential(
            LocallyConnected2d(12, 2, 63, 1, stride=1, bias=False),
            nn.BatchNorm2d(2),
            nn.ELU(),
        )
        self.conv4 = nn.Sequential(
        ...
        self.conv_con2 = nn.Sequential(
            LocallyConnected2d(20, 2, 63, 1, stride=1, bias=False),
            nn.BatchNorm2d(2),
            nn.ELU(),
        )
        self.conv8 = nn.Sequential(
...
class filter_deep_phase_unc(nn.Module):
    def __init__(self):
        ...
        self.block2 = block_2()
        self.block3 = block_3()
        self.block1_unc = block_1_unc()
        self.block2_unc = block_2_unc()
        self.block3_unc = block_3_unc()
        self.symmetry = Lambda(partial(symmetry, mode="imag"))
